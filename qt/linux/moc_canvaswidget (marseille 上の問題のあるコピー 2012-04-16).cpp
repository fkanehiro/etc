...
**
** Created: Mon Apr 16 08:09:37 2012
...
static const char qt_meta_stringdata_CanvasWidget[] = {
    "CanvasWidget\0"
};

const QMetaObject CanvasWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_CanvasWidget,
      qt_meta_data_CanvasWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CanvasWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CanvasWidget))
