...
#define VTIME
    ...
    const double vlimit = 1.5, alimit = 10.0;
...
#endif
#ifdef VTIME
        vconst.jacobian()(0,1) = -vmax;
        vconst.jacobian()(1,1) = -vmin;
#endif
...
#ifdef VTIME
        aconst.jacobian()(0,1) = -(vv + 5/2*amax*dt);
        aconst.jacobian()(1,1) =   vv - 5/2*amin*dt;
#endif
