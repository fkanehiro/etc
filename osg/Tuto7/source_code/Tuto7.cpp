/******************
Tutorial 7: Texturing and positioning 
By Franclin Foping 
...
//This function creates our quad
...
osg::ref_ptr<osg::Geode> myQuad ()
{
   ...
   vertices->push_back (osg::Vec3 ( 3.0, 0.0, 0.0));
   vertices->push_back (osg::Vec3 ( 3.0, 0.0, 3.0));
   ...
   osg::ref_ptr<osg::Image> image1 (osgDB::readImageFile("wood.png"));
   if (image1.get() == 0)
   {
      std::cerr << "wood.png'.\n";
      exit (EXIT_FAILURE);
...
int main()
{
	...
	osg::Vec3f quadPos = osg::Vec3f(5,2,3);
	...
	//nodess->setTextureAttributeAndModes(1,tex2.get(), osg::StateAttribute::ON);
